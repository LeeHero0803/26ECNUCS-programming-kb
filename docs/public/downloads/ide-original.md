...
<div align="center">
<img src="./img/vscode官网1.png" width="600px" />
</div>

根据你的系统选择对应的安装包（我们以 windows11 为例）
<div align="center">
<img src="./img/vscode官网2.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/vscode安装1.png" width="80px" />
</div>
...
<div align="center">
<img src="./img/msys2官网1.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/msys2安装1.png" width="80px" />
</div>

安装向导首页直接点击「下一步」
<div align="center">
<img src="./img/msys2安装2.png" width="600px" />
</div>

选择安装路径，我们使用默认路径 `C:\msys64`，也可根据磁盘空间自定义位置，确认后点击「下一步」
<div align="center">
<img src="./img/msys2安装3.png" width="600px" />
</div>

这里保持默认，点击「下一步」
<div align="center">
<img src="./img/msys2安装4.png" width="600px" />
</div>

等待安装完成，点击「下一步」
<div align="center">
<img src="./img/msys2安装5.png" width="600px" />
</div>

勾选`立即运行 MSYS2`，点击「完成」，会自动弹出 msys2 终端窗口
<div align="center">
<img src="./img/msys2安装6.png" width="600px" />
</div>
<div align="center">
<img src="./img/msys2安装7.png" width="600px" />
</div>
...
>   ```
> <div align="center">
> <img src="./img/清华源.png" width="600px" />
> </div>
> 两者效果是一致的😄
...
```
<div align="center">
<img src="./img/msys2安装8.png" width="600px" />
</div>

出现包选择提示时，直接按回车，默认安装全部组件

<div align="center">
<img src="./img/msys2安装9.png" width="600px" />
</div>

系统询问是否继续安装时，输入 `y` 并回车

<div align="center">
<img src="./img/msys2安装10.png" width="600px" />
</div>

等待所有包安装完成后，关闭终端窗口即可

<div align="center">
<img src="./img/msys2安装11.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/环境变量.png" width="800px" />
</div>

3. 在「系统变量」列表中找到 `Path`，双击打开编辑窗口
<div align="center">
<img src="./img/msys2安装12.png" width="420px" />
</div>

4. 点击「新建」，粘贴刚才复制的 `bin` 目录路径，点击「确定
<div align="center">
<img src="./img/msys2安装13.png" width="420px" />
</div>
...
<div align="center">
<img src="./img/msys2安装14.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/vscode中文插件.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/vscodecpp插件.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/第一个程序.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/调试.png" width="600px" />
</div>
...
- `c_cpp_properties.json` 决定 vscode 的语法检查、代码补全和悬停提示使用哪个标准
    ...
    <div align="center">
    <img src="./img/vscode标准1.png" width="600px" />
    </div>
...
- `tasks.json` 决定实际编译的标准
    ...
    <div align="center">
    <img src="./img/vscode标准2.png" width="500px" />
    </div>
...
- 示例 2：C11 泛型选择表达式 与 匿名结构体
    ...
    <div align="center">
    <img src="./img/vscode标准3.png" width="500px" />
    </div>
...
<div align="center">
<img src="./img/codeblocks安装1.png" width="80px" />
</div>

打开 `codeblocks-20.03mingw-32bit-nosetup` 文件夹，双击打开 `codeblocks.exe`
<div align="center">
<img src="./img/codeblocks安装2.png" width="600px" />
</div>

这里会检测你电脑自带的编译器，我们什么都不用管，点击「OK」
<div align="center">
<img src="./img/codeblocks安装3.png" width="400px" />
</div>

什么都不用管，点「OK」
<div align="center">
<img src="./img/codeblocks安装4.png" width="600px" />
</div>
...
点击 `File` → `New` → `Project...`
<div align="center">
<img src="./img/codeblocks安装5.png" width="600px" />
</div>

选择 `Console application`，点击 「Go」
<div align="center">
<img src="./img/codeblocks_第一个程序.png" width="600px" />
</div>

点击「Next」
<div align="center">
<img src="./img/codeblocks_第一个程序2.png" width="600px" />
</div>

选择 C，点击「Next」
<div align="center">
<img src="./img/codeblocks_第一个程序3.png" width="600px" />
</div>

设定项目名称和项目文件夹路径
<div align="center">
<img src="./img/codeblocks_第一个程序4.png" width="600px" />
</div>

点击「Next」
<div align="center">
<img src="./img/codeblocks_第一个程序5.png" width="600px" />
</div>

我们得到了一个默认的 C 语言控制台应用程序项目，点击「编译并运行」按钮
<div align="center">
<img src="./img/codeblocks_第一个程序6.png" width="600px" />
</div>

我们可以看到如下的输出
<div align="center">
<img src="./img/codeblocks_第一个程序7.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/codeblocks标准.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/trae安装2.png" width="600px" />
</div>
...
<div align="center">
<img src="./img/trae安装1.png" width="600px" />
</div>
...
编译助教提供的 `snake.c`，游玩经典游戏回味童年。
<div align="center">
<img src="./img/snake.png" width="400px" />
</div>

### 吃豆人

编译助教提供的 `pacman.c`，游玩经典游戏回味童年。
<div align="center">
<img src="./img/pacman.png" width="400px" />
</div>
